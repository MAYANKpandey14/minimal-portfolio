            ...
            <ul className="flex space-x-3 mb-4" aria-label="Social media links">
              <li>
                <a 
                  ...
                  className="p-2.5 rounded-full bg-card/50 border border-border/20 backdrop-blur-md text-muted-foreground hover:text-primary hover:border-primary/30 transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-105 flex items-center justify-center"
              ...
              <li>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-2.5 rounded-full bg-card/50 border border-border/20 backdrop-blur-md text-muted-foreground hover:text-emerald-500 hover:border-emerald-500/30 transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-105 flex items-center justify-center"
